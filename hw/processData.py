...
df = pd.read_csv(
    'https://raw.githubusercontent.com/MatthewFried/Old-DS-Examples/master/Week2/cars-sample35.txt', names=['price', 'maintenance_cost', 'number_of_doors', 'number_of_passengers', 'luggage_capacity', 'safety_rating', 'classification_of_vehicle'], header=None)
